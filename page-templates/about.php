        ...
        <div class="col-md-12">
            <div class="mission section">
                <h1 class="heading" id="about-heading">
                    <?php
echo get_theme_mod( 'settings_about_title', __( 'About Page Title', 'customizer' ) );
//echo esc_html(cs_get_customize_option('about_heading'));
?>
                </h1>
                <div id="about-description">
	                <?php
echo apply_filters( 'the_content', get_theme_mod( 'settings_about_description' ), __( 'About Description', 'customizer' ) );
?>
                </div>
            </div>
        </div>
